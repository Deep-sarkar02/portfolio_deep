...
const  DemoComputer = (props) => {
  const group = useRef()
    // here we will need a vedio texture 
  // first add the text variable then we will open the mesh tag and we will edit it
  // we will take the txture from the projects
  const txt = useVideoTexture(props.texture)
  const { nodes, materials} = useGLTF('/models/computer.glb')
  
  // we will use the useEffect to make the texture upside down
  // here we will change flip the image
  useEffect(()=>
{
    if(txt){
        txt.flipY = false;
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        >
        {/**now we will edit it for eaach of the vedio to present */}\
